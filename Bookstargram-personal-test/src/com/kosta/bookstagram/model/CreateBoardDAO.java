...
public class CreateBoardDAO extends BoardDAO {
	...
	public BoardVO selectBoard(int boardNo) throws SQLException {
		...
		try {
			...
			if (rs.next()) {
				cbvo = new CreateBoardVO(rs.getInt(1),rs.getInt(2),rs.getString(3),rs.getString(4),rs.getInt(5),rs.getInt(6),rs.getInt(7),rs.getString(8),rs.getString(9),rs.getInt(10));
			}
